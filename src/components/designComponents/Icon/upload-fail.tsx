...
import { type UploadFailProps, type UploadFailRef } from '../../../types/designComponents/Icons/uploadFail';

function geIconSize (size: UploadFailProps['size']): { height: number, width: number } {
  switch (size) {
...
const UploadFail = React.forwardRef(function UploadFail (props: UploadFailProps, ref: UploadFailRef) {
...
UploadFail.defaultProps = {
  size: 's',
  color: '#09244B'
};

UploadFail.propTypes = {
